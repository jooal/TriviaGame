...
// function startGame() {
//     var questionsRight=[];
//     $("#right-counter").text("Questions right:" + questionsRight);
//     var questionsWrong=[];
//     $("#wrong-counter").text("Questions wrong: " + questionsWrong);
...
var questionsArray=[
    ...
    {question:"What are the colors that appear on the flag of France?", 
    choices:["Blue, white, & red", "Yellow", "White, blue, & green", "White & green"],
    ...
    choices:["2009", "2014", "1998", "2018"],
    answer: "2009"},

    {question: "What is the name for the monetary unit used in Thailand?",
    choices:["Thai Baht", "Thai Tai", "Thai Bet", "Thai Coin"], 
    answer: "Thai Baht"},
    ...
    choices:["Purging", "Anorexia", "Pica", "Rumination"],
    answer: "Pica"},
    ...
    function timer(){
        ...
        var timer = setInterval(function(){
            ...
            if (sec < 0) {
                ...
                $("#correct-answer").append("The correct answer was: "+ questionsArray[this.currentQuestion].answer)
            }
       ...
       function nextQuestion(){
        ...
        function answeredIncorrectly() {
          ...
          $("#correct-answer").append("The correct answer was: " + questionsArray[currentQuestion].answer);
          setTimeout(nextQuestion(), 3 * 1000);
        }
